...
public:
	...
	void prepQuery(string table, string stmtOperation, int id); //Get specific item data or all item data from table
	void prepQueryRng(string table, string stmtOperation, Range ids); //Get range of item data from table
	void prepQueryVec(string table, string stmtOperation, vector<int> ids); //Get multiple specific item data from table
	bool openDB();
	bool openSave();
...
private:
	...
	void buildStmt(string table, string operation, int id);
	void buildStmt(string table, string operation, Range ids);
	void buildStmt(string table, string operation, vector<int> ids);
	...
	const char* sqlStmt2;
	string whereConds; //Store where conditions for certain query stmt builders
